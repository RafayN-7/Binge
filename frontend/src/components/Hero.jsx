...
fetch('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1', options)
  ...
  return (
    <div className='text-white relative'>
        ...
        <img src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path}`} alt="bg-img" className='w-full rounded-2xl h-[620px] object-center object-cover'/>
        <h3 className="flex justify-center items-center py-3 text-2xl font-bold">{movie.title}
        </h3>
        ...
        <div className='flex space-x-2 md:space-x-4 absolute bottom-3 left-4 md:bottom-8 md:left-10 font-medium mb-10 ml-10'>
          ...
          {/*
            ...
            <button className='flex justify-center items-center bg-[#e50914] text-white py-3 px-4 rounded-full cursor-pointer text-sm md:text-base'><Play className='mr-2 w-4 h-5 md:w-5 md:h-5 ' />Watch Now</button>
            </Link>
